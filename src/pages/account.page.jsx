...
function AccountPage() {
    ...
    const { data: orders, isLoading: isOrdersLoading, isError } = useGetOrderForUserQuery();
                                ...
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        <div className="flex gap-2 mt-1">
                                            <Badge variant={order.orderStatus === "PENDING" ? "secondary" : "success"}>
                                                {order.orderStatus}
                                            </Badge>
                                            <Badge variant={order.paymentStatus === "PENDING" ? "secondary" : "success"}>
                                                {order.paymentStatus}
                                            </Badge>
                                        </div>
                                    </div>
